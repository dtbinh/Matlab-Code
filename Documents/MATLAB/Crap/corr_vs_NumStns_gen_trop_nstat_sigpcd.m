...
DIR_NAME = 'Pseudoproxies/trop_nstat_sigpcd' ; mkdir(DIR_NAME);
...
% S_lat = 15; N_lat = 42; W_lon = 235; E_lon = 270; % USA
...
for NUM_STNS = 3:STN_MAX
    ...
    stn_ts = nan(NUM_TRIALS,NUM_STNS, NUM_YRS);
    stn_pr = nan(NUM_TRIALS,NUM_STNS, NUM_YRS);
    ...
    save([DIR_NAME,'/CalWdw:',num2str(CAL_WDW(c,1)),'-',num2str(CAL_WDW(c,end)),'/',num2str(NUM_STNS),'stns_1000prox.mat'], ...
             'stn_lat','stn_lon','stn_ts','indice_pool','corr_ts');
...
%      'all_stn_corr_CPS_RV', 'all_stn_rmse_CPS_RV' , 'indice_pool_num'         );
% 
% %% Making the plot
% 
% % Percentiles
