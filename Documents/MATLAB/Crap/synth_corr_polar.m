...
S_lat = -90; N_lat = -60; W_lon = 180; E_lon = 360;
...
if  ~exist(['Synth_corr_',num2str(window),'yrwin_polar/run',num2str(n),'syncorr.mat'],'file')
...
save(['Synth_corr_',num2str(window),'yrwin_polar/run',num2str(n),'syncorr.mat'],'ts_synruncorr','pr_synruncorr');
toc;
end
