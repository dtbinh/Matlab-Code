...
S_lat = -60; N_lat = 60; W_lon = 60; E_lon = 120;
...
if  ~exist(['Synth_corr_',num2str(window),'yrwin_0-120E/run',num2str(n),'syncorr.mat'],'file')
...
save(['Synth_corr_',num2str(window),'yrwin_0-120E/run',num2str(n),'syncorr.mat'],'ts_synruncorr','pr_synruncorr');
toc;
end
