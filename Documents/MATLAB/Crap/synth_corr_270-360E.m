...
% and the Nino3.4 index, and save them
...
S_lat = 0; N_lat = 60; W_lon = 270; E_lon = 320;
...
if  ~exist(['Synth_corr_',num2str(window),'yrwin_270-360E/run',num2str(n),'syncorr.mat'],'file')
...
save(['Synth_corr_',num2str(window),'yrwin_270-360E/run',num2str(n),'syncorr.mat'],'ts_synruncorr','pr_synruncorr');
toc;
end
