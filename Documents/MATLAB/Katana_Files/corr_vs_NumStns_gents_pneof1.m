...
fprintf(fid,'rc31_eof_ts_fm1 > 0.01 for 1:floor(NUM_STNS/2) Proxies, rc31_eof_ts_fm1 < -0.01 for (floor(NUM_STNS/2)+1):NUM_STNS Proxies\n');
fclose(fid);
