...
%     stn_ts_id = nan(NUM_TRIALS,NUM_STNS, NUM_YRS,'single');
%     stn_pr_id = nan(NUM_TRIALS,NUM_STNS, NUM_YRS,'single');
...
%             stn_ts_id(m,n,:) = single(ats(:,stn_lat(m,n),stn_lon(m,n)));
%             stn_pr_id(m,n,:) = single(apr(:,stn_lat(m,n),stn_lon(m,n)));
